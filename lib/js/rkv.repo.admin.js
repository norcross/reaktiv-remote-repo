...
// **************************************************************
	...
	$( 'p.repo-cal-field' ).each(function() {

		stampfield	= $( this ).find( 'input.repo-cal-stamp' );

		$( this ).find( 'input.repo-cal-text' ).datepick({
			defaultDate:		null,
...
//********************************************************
	...
	jQuery( 'tr.repo-upload-item-field' ).on('click', 'input.repo-file-upload', function( event ){

		event.preventDefault();

		//get my field ID for later
		fieldbox = jQuery( this ).prev( 'input.repo-item-file-upload' );
		...
		file_frame = wp.media.frames.file_frame = wp.media({
			title: rkvAsset.uptitle,
			button: {
				text: rkvAsset.upbutton
			},
			multiple: false
		});
